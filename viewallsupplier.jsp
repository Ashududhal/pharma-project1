...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<%
		...
		List<Supplier> ae = bm.viewallsupplier();
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading"><b>Suppliers are Here...</b></div>
						...
						<c:forEach items="${sessionScope.list1}" var="l">
							<tr>
								<td data-field="id" data-sortable="true"><center><c:out
										value="${l.supid} " /></center></td>
								<td data-field="id1" data-sortable="true"><center><c:out
										value="${l.sname}" /></center></td>
								<td data-field="id2" data-sortable="true"><center><c:out
										value="${l.smobile} " /></center></td>
								<td data-field="id3" data-sortable="true"><center><c:out
										value="${l.semail} " /></center></td>
								<td data-field="id4" data-sortable="true"><center><c:out
										value="${l.saddress} " /></center></td>
								<td><center><a href="UpdateSupplier?id=${l.supid}" style="color: blue;">Update</a></center></td>
								<td><center><a href="DeleteSupplier?id=${l.supid}" style="color: blue;">Delete</a></center></td>
