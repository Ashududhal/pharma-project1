					...
					<form class="form-horizontal" action="Update"
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="mcompany" value="${list.mcompany}" type="text"
										placeholder=" Medicine Company" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="mdescription" value="${list.mdescription}" type="text"
										placeholder="Descritption" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="quantity" value="${list.quantity}" type="text" placeholder="Quantity"
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="price" value="${list.price}" type="text" placeholder="Prize"
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">Manufacturing
									Date</label>
								<div class="col-md-6">
									<input id="name" name="mdate" value="${list.mdate}" type="text" placeholder="Manufacturing Date"
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">Expiry
									Date</label>
								<div class="col-md-6">
									<input id="name" name="edate" value="${list.edate}" type="text" placeholder="Expiry Date"
										class="form-control">
								</div>
							</div>
